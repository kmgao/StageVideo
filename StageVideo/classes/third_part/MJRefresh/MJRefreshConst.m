...
NSString *const MJRefreshFooterPullToRefresh = @"Push up loading more data";
NSString *const MJRefreshFooterReleaseToRefresh = @"Undo loading more data";//松开立即加载更多数据
NSString *const MJRefreshFooterRefreshing = @"loading data..."; //MJ哥正在帮你加载数据...
