...
{
    //创建顶部可滑动的tab
    self.topScrollViewBg = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width, kHeightOfTopScrollView)];
    [self addSubview:self.topScrollViewBg];
...
- (void)createNameButtons
{
    ...
    CGFloat buttonWith = (self.frame.size.width  - kWidthOfButtonMargin*2)/_viewArray.count;
