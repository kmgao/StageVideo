...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.customerLeftView = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height)];
        self.customerLeftView.backgroundColor = [UIColor clearColor];
    }
    return self;
}
